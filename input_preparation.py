...
if __name__ == '__main__':
    ...
    # parser.add_argument('--dataset_path', type=str, default='/media/whd/test/randla-test/randla_l12345_stacking/data_pro/dataset_class13/SensatUrban/',required=True, help='the number of GPUs to use [default: 0]')
    # FLAGS = parser.parse_args()
    dataset_name = 'SensatUrban'
    dataset_path = 'data_pro/dataset_class13/SensatUrban/'
    ...
    for sample_type in preparation_types:
        for pc_path in files:
            ...
            # check if it has already calculatedf
